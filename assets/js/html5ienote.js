/*
   ================================================================
   Ago Author：sarfraznawaz
   Now Author   : CodeZ5 (z5@html5all.com) 
   Time     : 2014-5-20
   ================================================================
*/

var stickywidth = 200;  // 宽度不能少于200
var stickyheight = 200; // 高度不能少于200 
var max_notes = 500; // 便签可以存储最大数量
...
html5sticky.addNote = function(){
    ...
    if (tnotes === max_notes){
       html5sticky.showMessage('#FFE16B', 'black', '如果添加太多，可以删除一些了.');
       return false;
    }
...
html5sticky.nohtml5 = function(){
   html5sticky.showMessage('#FFE16B', 'black', '不好意思中，您的浏览器不支持此版本嗯。');
};
...
html5sticky.addUtilityButtons = function(el){
   ...
   $('.icons-footer').append('<img class="left shrink ficon" src="assets/img/shrink.png" alt="" title="收缩/扩展">');
   $('.icons-footer').append('<img class="left alarm ficon" src="assets/img/alarm.png" alt="" title="设置便签">');
   $('.icons-footer').append('<img class="left lock ficon" src="assets/img/lock.png" alt="" title="锁定便条">');
   $('.icons-footer').append('<img class="left settings ficon" src="assets/img/settings.png" alt="" title="设置">');
   $('.icons-footer').append('<img class="left email ficon" src="assets/img/email.png" alt="" title="email ">');
   $('.icons-footer').append('<img class="left tweet ficon" src="assets/img/tweet.png" alt="" title="   ">');
   $('.icons-footer').append('<img class="left share ficon" src="assets/img/share.png" alt="" title="分享">');
...
html5sticky.saveNote = function(el){
   if (Modernizr.localstorage){
      ...
      html5sticky.showMessage('#CCC', 'black', '保存成功 :)');
...
html5sticky.editNote = function($clone, el){
   ...
   // put in Close button
   $('<a href="#" class="close_stickynote"><img style="height:50px; width:50px;" src="assets/img/remove.png" alt="" title="关闭"></a>')
      .css({
         position:'absolute',
         top:7,
         right:5
   ...
   // put in Save button
   $('<a href="#" class="save_stickynote"><img style="height:50px; width:50px;" src="assets/img/savebig.png" alt="" title="保存"></a>')
      .css({
         position:'absolute',
         top:7,
         right:60
   ...
   // put in Tip
   $('<span class="tip">备注: 可用的HTML标签: <code>')
      .css({
         position:'absolute',
         bottom:10,
         left:15
...
html5sticky.enlargeNote = function(el){
      ...
      if (Modernizr.localstorage){
         ...
         dateStr = (dateStr.length > 0) ? '新增于: ' + dateStr : '';
